...
def main(page: ft.Page):
                            ...
                            [
                                ...
                                ft.TextButton(
                                    content=ft.Container(
                                        ft.Text(value="Estudiante", weight=ft.FontWeight.W_700, size=20, color="black", text_align='center')
                                    ),
                                    on_click=goEstu
                                ),
    ...
    def estudiante_view():
        ...
        container = ft.Container(
            ft.Column([
                ...
                ft.Column([
                    ft.TextField(hint_text='Usuario Estudiante', bgcolor='white', border_radius=10, width=380, height=50),
                    ft.TextField(hint_text='Clave de acceso', bgcolor='white', border_radius=10, width=380, height=50),
                ]),
                ft.Row([
    ...
    def docente_view():
        ...
        container = ft.Container(
            ft.Column([
                ft.Container(
                    ft.Row([ft.Text('Inicio de Sesion', color='#0D257C', weight=ft.FontWeight.BOLD, size=20,font_family='OpenSans',text_align='center')], 
                    alignment=ft.MainAxisAlignment.CENTER),
                    bgcolor='white', 
                    width=450, 
                    height=50, 
                ...
                ft.Row([ft.Image('https://i.postimg.cc/rszvbGS4/4.png', border_radius=100)], alignment=ft.MainAxisAlignment.CENTER, height=100),
                ft.Divider(height=30, color='transparent'),
                ft.Column([
                    ft.TextField(hint_text='Usuario Docente', bgcolor='white', border_radius=10, width=380, height=50),
                    ft.TextField(hint_text='Clave de acceso', bgcolor='white', border_radius=10, width=380, height=50),]),
                ft.Row([ft.FilledButton('Aceptar', style=ft.ButtonStyle(bgcolor='#3F844B'))
                ], alignment=ft.MainAxisAlignment.CENTER),]),
            padding=20,
            width=page.width*0.9 if page.width < 600 else page.width*0.3,
            height=page.width*0.9 if page.width < 600 else page.width*0.3,
